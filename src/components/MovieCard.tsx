      ...
      <div className="relative overflow-hidden rounded-lg bg-gray-900">
        <img 
          ...
          onError={(e) => {
            ...
            img.src = "https://eticketsolutions.com/demo/themes/e-ticket/img/movie.jpg"; // Fallback image path
          }}
          ...
          <div className="absolute bottom-0 left-0 w-full p-4">
            ...
            <button 
              ...
              className={`rounded-full p-2 backdrop-blur-sm transition-colorshover:bg-white hover:text-black" ${
                isWatchLater ? 'bg-green-500 text-white' : 'bg-white/20 hover:bg-white/30'
              }`}
            >
              <Plus className="h-4 w-4" />
            </button>
